...
static __u32 rtab1[QDISC_RATE_TABLE_SIZE];
static __u32 rtab2[QDISC_RATE_TABLE_SIZE];
...
/* encode overhead and mpu, 8 bits each, into lower 16 bits */
	...
	addattr_l(n, 10000, TCA_HTB_RTAB, rtab, sizeof(rtab1));
	addattr_l(n, 19000, TCA_HTB_CTAB, ctab, sizeof(rtab2));
	tail->rta_len = (((void*)n)+NLMSG_ALIGN(n->nlmsg_len)) - (void*)tail;
	return 0;
}

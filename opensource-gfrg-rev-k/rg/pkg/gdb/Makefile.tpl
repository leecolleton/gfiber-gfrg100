...
BUILD_EXPORTS = \
	...
	JMK_CXXFLAGS="$(CXXFLAGS_FOR_BUILD)"; export JMK_CXXFLAGS; \
...
HOST_EXPORTS = \
	...
	CONFIG_SHELL="$(SHELL)"; export CONFIG_SHELL; \
	CXX="$(CXX)"; export CXX; \
	JMK_CXXFLAGS="$(JMK_CXXFLAGS)"; export JMK_CXXFLAGS; \
	AR="$(AR)"; export AR; \
	AS="$(AS)"; export AS; \
...
BASE_TARGET_EXPORTS = \
	...
	JMK_CXXFLAGS="$(CXXFLAGS_FOR_TARGET)"; export JMK_CXXFLAGS; \
...
CXX = @CXX@
JMK_CXXFLAGS = @JMK_CXXFLAGS@
LIBCXXFLAGS = $(JMK_CXXFLAGS) -fno-implicit-templates
...
CXXFLAGS_FOR_TARGET = $(JMK_CXXFLAGS)
...
EXTRA_TARGET_FLAGS = \
	...
	'CXX=$$(CXX_FOR_TARGET)' \
	'JMK_CXXFLAGS=$$(CXXFLAGS_FOR_TARGET)' \

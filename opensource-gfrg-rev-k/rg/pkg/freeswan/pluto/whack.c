...
main(int argc, char **argv)
{
	...
	*tunnel_af_used_by = NULL;
	...
	case CD_DPDIDLETIMEOUT:
	    msg.dpd_idle_timeout = opt_whole;
	    continue;
    ...
    if (msg.dpd_delay && !msg.dpd_idle_timeout)
    {
	    diag("dpdidletimeout not specified, defaulting to dpd delay\n");
	    msg.dpd_idle_timeout = msg.dpd_delay;
    }

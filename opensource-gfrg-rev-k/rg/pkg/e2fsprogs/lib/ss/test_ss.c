 ...
 *------------------------------------------------------------------
 *
 * $Source: /arch/cvs/rg/pkg/e2fsprogs/lib/ss/test_ss.c,v $
 * $Revision: 1.2 $
 * $Date: 2003/11/30 13:49:17 $
 * $State: Exp $
 * $Author: derry $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.2  2003/11/30 13:49:17  derry
 * cvs_vendor_fixup: vendor branch fixup: 1.2 <-- 1.1, 1.1.1.1
 * NOTIFY: cancel
 *
 * Revision 1.1.1.1  2003/04/24 19:38:24  alex
 * Initial import of e2fs utils version 1.32
 *
...
static char const rcsid_test_c[] =
    "$Header: /arch/cvs/rg/pkg/e2fsprogs/lib/ss/test_ss.c,v 1.2 2003/11/30 13:49:17 derry Exp $";
#endif /* lint */

 ...
 *  $Id$
 *  $Log$
 *  Revision 1.2  2011/07/27 08:22:04  yoavp
 *  AUTO MERGE: 1 <- branch-5_4
 *  merge R86661 (import of mtd-utils-1_3_1 from branch-vendor) from branch-5_4_8_1
 *  to 5.4
 *  this is the second half of merge to product that was mistakenly cut
 *  NOTIFY: automerge
 *
 *  Revision 1.1.16.1  2011/07/27 08:12:05  yoavp
 *  merge R86661 (import of mtd-utils-1_3_1 from branch-vendor) from branch-5_4_8_1
 *  to 5.4
 *  this is the second half of merge to product that was mistakenly cut
 *

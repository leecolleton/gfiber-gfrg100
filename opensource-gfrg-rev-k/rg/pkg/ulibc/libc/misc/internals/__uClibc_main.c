...
void   __check_quarantine(void) attribute_hidden;
    __check_quarantine();
#endif
#endif
}
...
#ifdef __CONFIG_RG_DBG_ULIBC_MALLOC__
static void memdebug_handler(attribute_unused int sig)
{
    dump_alloc_mem();
}
#endif
...
# endif
	...
	*(__h_errno_location()) = 0;
	...
	action.sa_handler = memdebug_handler;
	sigaction(59, &action, NULL);
    }
#endif
    /*

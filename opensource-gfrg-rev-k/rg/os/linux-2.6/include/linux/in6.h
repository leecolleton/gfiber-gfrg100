...
/* 
* TI Extension:
   socket option for ability to recieve the relevent for cable TI modem
   information through the IPv6 socket.
*/
...
*/
#ifdef CONFIG_TI_IP_PKTINFO_SOCKOPT
#ifndef TI_PKTINFO_STRUST
#define TI_PKTINFO_STRUST
struct ti_pktinfo
{
	int		ifcpe_side;
};

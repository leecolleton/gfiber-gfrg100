...
typedef enum {
    KMALLOC_DEBUG_LEVEL_ERROR = 0,
    KMALLOC_DEBUG_LEVEL_WARNING = 1,
    KMALLOC_DEBUG_LEVEL_INFO = 2,
} kmalloc_debug_level_t;
...
/* request kmem_cache_create to use gfporder of
 * ((flags & SLAB_HINT_SIZE_MASK) >> SLAB_HINT_SIZE_SHIFT)
 */
#define SLAB_HINT_SIZE_MASK	0x00E00000UL	 
#define SLAB_HINT_SIZE_SHIFT	0x15
...
int kmem_cache_has_free_space(struct kmem_cache *cachep);
const char *kmem_cache_name(struct kmem_cache *);
int kmem_ptr_validate(struct kmem_cache *cachep, const void *ptr);

extern unsigned int kmem_get_free_ram_size(int full);
...
#ifndef CONFIG_NUMA
#ifndef CONFIG_RG_DEBUG_KMALLOC

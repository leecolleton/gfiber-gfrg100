...
/* $Id: applicom.c,v 1.4 2010/04/08 18:46:26 dmitri Exp $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: applicom.c,v 1.4 2010/04/08 18:46:26 dmitri Exp $\n");
...
{				/* @ ADG ou ATO selon le cas */
	...
	case 5:
		...
		break;
	case 6:
		printk(KERN_INFO "APPLICOM driver release .... V2.8.0 ($Revision: 1.4 $)\n");

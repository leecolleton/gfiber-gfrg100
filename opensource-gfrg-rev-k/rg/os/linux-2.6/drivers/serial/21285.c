 ...
 *
 *  $Id: 21285.c,v 1.4 2010/04/08 19:13:51 dmitri Exp $
 */
...
static int __init serial21285_init(void)
{
	...
	printk(KERN_INFO "Serial: 21285 driver $Revision: 1.4 $\n");
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Intel Footbridge (21285) serial driver $Revision: 1.4 $");

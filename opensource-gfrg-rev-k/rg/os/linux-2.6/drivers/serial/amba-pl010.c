 ...
 *
 *  $Id: amba-pl010.c,v 1.4 2010/04/08 19:13:51 dmitri Exp $
 *
...
static int __init pl010_init(void)
{
	...
	printk(KERN_INFO "Serial: AMBA driver $Revision: 1.4 $\n");
...
MODULE_DESCRIPTION("ARM AMBA serial port driver $Revision: 1.4 $");
MODULE_LICENSE("GPL");

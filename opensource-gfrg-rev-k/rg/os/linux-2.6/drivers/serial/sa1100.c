 ...
 *
 *  $Id: sa1100.c,v 1.4 2010/04/08 19:13:51 dmitri Exp $
 *
 */
...
static int __init sa1100_serial_init(void)
{
	...
	printk(KERN_INFO "Serial: SA11x0 driver $Revision: 1.4 $\n");
...
MODULE_DESCRIPTION("SA1100 generic serial port driver $Revision: 1.4 $");
MODULE_LICENSE("GPL");

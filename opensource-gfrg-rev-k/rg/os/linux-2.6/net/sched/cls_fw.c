...
/* Also defined in pkg/kos/knet.h */
#define RG_QOS_TX_CLASS_SHIFT 0
#define RG_QOS_TX_CLASS_MASK 0x000007FF
#define RG_QOS_RX_CLASS_SHIFT 11
#define RG_QOS_RX_CLASS_MASK 0x003FF800
			  ...
			  struct tcf_result *res)
{
	...
	{
	    id &= RG_QOS_TX_CLASS_MASK;
	    id >>= RG_QOS_TX_CLASS_SHIFT;
	}
	else
	{
	    id &= RG_QOS_RX_CLASS_MASK;
	    id >>= RG_QOS_RX_CLASS_SHIFT;
	}
#endif

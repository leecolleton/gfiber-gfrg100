...
struct sk_buff *(*atm_alloc_tx_override)(struct atm_vcc *, unsigned int) = NULL;
EXPORT_SYMBOL(atm_alloc_tx_override);
...
static struct sk_buff *alloc_tx(struct atm_vcc *vcc,unsigned int size)
{
	...
	if (atm_alloc_tx_override != NULL)
		return atm_alloc_tx_override(vcc, size);
